...
export const EventCard = ({ event, selectedTeam, onSelectTeam }: EventCardProps) => {
      ...
      <CardContent className="p-0">
        ...
        <div className="p-4 space-y-3">
          ...
          <Button
            ...
            onClick={() => onSelectTeam(event.event_id, event.away_team_id, event.away_moneyline)}
          >
          ...
          <Button
            ...
            className="w-full justify-between h-auto py-3"
            onClick={() => onSelectTeam(event.event_id, event.home_team_id, event.home_moneyline)}
          >
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center font-bold text-sm">
